...
//		List<CartItem> cartItemList = user.getShoppingCart().getCartItemList();
	...
	private String checkoutTheShoppingCart(
			Model model,
			Principal principal,
...
//		List<CartItem> cartItemList = shoppingCart.getCartItemList();
		...
		pdfGenerator.generateItenerary(order, "C:\\Users\\WMents\\Desktop\\Order_PDF\\orders\\"+order.getId()+".pdf");
...
//		 Finding userSHipping as per the userShippingID
	...
	private String setPaymentMethod(
			Model model,
			Principal principal,
